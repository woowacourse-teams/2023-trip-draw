...
import dev.tripdraw.trip.application.PointService;
...
public class PointController {
    ...
    public ResponseEntity<PointResponse> readPointById(
        ...
        PointResponse response = pointService.read(loginUser, tripId, pointId);
    ...
    public ResponseEntity<Void> deletePoint(
        ...
        pointService.delete(loginUser, pointId, tripId);
